...
# ── Alpha Brokers (notificar para Blumar, Cermaq, Multi X) ────────────────────

ALPHA_BROKERS = {
    "nombre":    "ALPHA BROKERS",
    "direccion": "2875 N.W. 82 AVENUE MIAMI 33173 - U.S.A.",
    "telefono":  "PH: 305 594 9290",
}

# ── Configuraciones por pesquera ──────────────────────────────────────────────
# notificar:         "destinatario" → casilla 9 copia al destinatario
#                    "alpha_brokers" → casilla 9 usa ALPHA_BROKERS
# descripcion_fuente: "guia"    → casilla 11 se construye desde extractor_guias
#                     "factura" → casilla 11 se construye desde extractor_facturas
